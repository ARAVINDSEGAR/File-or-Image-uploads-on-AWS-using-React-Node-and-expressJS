...
data.append( 'fileImage', this.state.selectedFile, this.state.selectedFile.name );
axios.post( '/api/file/single-file-upload', data, {
    headers: {
...
axios.post( '/api/file/multiple-file-upload', data, {
    headers: {
     'accept': 'application/json',
     'Accept-Language': 'en-US,en;q=0.8',
     'Content-Type': `multipart/form-data; boundary=${data._boundary}`,
...
{/* Single File Upload*/}
     <div className="card border-light mb-3 mt-5" style={{ boxShadow: '0 5px 10px 2px rgba(195,192,192,.5)' }}>
      ...
      <div className="card-body">
       <p className="card-text">Please upload your file:</p>
...
{/* Multiple File Upload */}
     <div className="card border-light mb-3" style={{ boxShadow: '0 5px 10px 2px rgba(195,192,192,.5)' }}>
      ...
      <div className="card-body">
       <p className="card-text">Please upload multiple files:</p>

...
/**
 * @route POST api/file/business-img-upload
  ...
  fileUpload(req, res, (error) => {
    ...
    if (error) {
      ...
      if (req.file === undefined) {
        ...
        // Save the file name into database into file model
        res.json({
          image: imageName,
...
/**
 * @route POST /api/file/business-gallery-upload
